...
public class SignInFragment extends Fragment {
    ...
    private TextView txtSignUp,txtSignInAdmin;
    ...
    private void init() {
        ...
        txtSignInAdmin = view.findViewById(R.id.txtSignInAdmin);
        ...
        txtSignInAdmin.setOnClickListener(v -> {
            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameAuthContainer,new SignInAdmin()).commit();
        });
    ...
    private void login(){
        ...
        dialog.show();
        StringRequest request = new StringRequest(Request.Method.POST, Server.lOGIN, response -> {
            try {
                ...
                if(object.getBoolean("success")){
                    ...
                    startActivity(new Intent(((AuthActivity)getContext()), Trangchu.class));
