...
import com.qtthai.app_ban_hang.adapter.ViewPagerAdapter;
...
public class OnBoardActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        addDots(0);
        viewPager.addOnPageChangeListener(listerner);
    ...
    private ViewPager.OnPageChangeListener listerner = new ViewPager.OnPageChangeListener() {
        @Override
